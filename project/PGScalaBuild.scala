...
object Publications {
  ...
  val pgscalaConvertersJava  = "org.pgscala" %  "pgscala-converters-java"  % "0.2.1-1"
  val pgscalaConvertersScala = "org.pgscala" %% "pgscala-converters-scala" % "0.2.1-1"
  val pgscala                = "org.pgscala" %% "pgscala"                  % "0.7.6-1"
}
